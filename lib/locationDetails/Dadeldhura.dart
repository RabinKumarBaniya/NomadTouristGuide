            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "Dadeldhura district (Nepali: डडेलधुरा जिल्ला), a part of Sudurpashchim Province, is one of the seventy-seven districts of Nepal. The district, with Dadeldhura as its district headquarters, covers an area of 1,538 km (594 sq mi).",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color: Colors.grey[800],
                        fontSize: 20),
